...
<!-- Cars -->
  ...
  <body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Araç<span> deposu</span></a>
      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
						<div class="img" style="background-image: url(asset/home/images/bg_1.jpg);"></div>
						<div class="img" style="background-image: url(asset/home/images/bg_2.jpg);"></div>
						  ...
						  <div class="tab-content" id="pills-tabContent">
						    <div class="tab-pane fade show active" id="pills-description" role="tabpanel" aria-labelledby="pills-description-tab">
						    	<div class="row">
						    		<div class="col-md-4">
						    			<ul class="features">
						    				<li class="check"><span class="ion-ios-checkmark"></span>ABC</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Hava Yastığı</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Immobilizer</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Yokuş Kalkış Desteği</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Şeritten Ayrılma İkazı</li>
						    			</ul>
						    		</div>
						    		<div class="col-md-4">
						    			<ul class="features">
						    				<li class="check"><span class="ion-ios-checkmark"></span>Radyo - CD Çalar</li>
						    				<li class="remove"><span class="ion-ios-close"></span>Bluetooth - Telefon</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Navigasyon</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>TV</li>
						    				<li class="remove"><span class="ion-ios-close"></span>Arka Eğlence Paketi</li>
						    			</ul>
						    		</div>
						    		<div class="col-md-4">
						    			<ul class="features">
						    				<li class="check"><span class="ion-ios-checkmark"></span>Klima</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Hız Sabitleyici</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Geri Görüş Kamerası</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Boya</li>
						    				<li class="check"><span class="ion-ios-checkmark"></span>Değişen</li>
						    			</ul>
						    		</div>
						    	</div>
						    </div>
